...
import { NotionSearchPayload, NotionSearchResponse, NotionUserDetailResponse, NotionBlockDetailResponse } from './types';
...
export class NotionWrapper {
	 ...
	 */
	private sendHttpRequest = async (req: AxiosRequestConfig): Promise<any> => {
