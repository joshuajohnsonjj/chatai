...
import { GetChatResponseQueryDto, type GetChatResponseResponseDto, ListChatQueryDto, type ListChatResponseDto } from './dto/message.dto';
...
export class ChatController {
  ...
  @Post()
	async startNewChat (
    @Body() params: StartNewChatQueryDto
	): Promise<StartNewChatResponseDto> {
		try {
